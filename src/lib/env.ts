...
export const env = envSchema.parse({
  ...
  FEATURE_NUDGES: (process.env.FEATURE_NUDGES || 'true').toLowerCase(),
  FEATURE_ONBOARDING: (process.env.FEATURE_ONBOARDING || 'false').toLowerCase(),
  WHOP_WEBHOOK_SECRET: process.env.WHOP_WEBHOOK_SECRET,
  ADMIN_TASK_TOKEN: process.env.ADMIN_TASK_TOKEN,
  NUDGES_ENABLED: (process.env.NUDGES_ENABLED || 'false').toLowerCase(),
